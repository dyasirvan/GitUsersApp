...
class FavoriteAdapter(private val listAccount: List<ResultItemsSearch>) : RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder>() {
    ...
    fun getData(position: Int): ResultItemsSearch {
