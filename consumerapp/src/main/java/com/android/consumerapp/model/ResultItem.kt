...
import com.android.consumerapp.utils.Constants
...
@Ignore
fun ResultItem(id: Int): ResultItem {
    val ris = ResultItem()
    ris.id = id
    return ris
}
...
@Ignore
fun fromContentValues(values: ContentValues): ResultItem? {
    val resultItemsSearch = ResultItem(-1)
